...
for file in os.listdir(input_dir):
    ...
    image_data = utils.image.img_b64_to_arr(data["imageData"]) # decodes the image from the json
    ...
    label, _ = utils.shapes_to_label(image_data.shape, data["shapes"], label_name_to_value) # convert polygon vector into 2d label image
